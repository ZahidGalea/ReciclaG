...
class InscribirPunto(forms.ModelForm):
    ...
    ruta_imagen = forms.ImageField(label='Imagen')
    ...
    horario_apert_lunes = forms.TimeField(label='Apertura Lunes', required=False,
                                          widget=TimePickerInput(format='%H:%S'))
    horario_cierr_lunes = forms.TimeField(label='Cierre Lunes', required=False, widget=TimePickerInput(format='%H:%S'))
